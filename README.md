...
I'm Billy, a student at Binus University in the Faculty of Computer Science majoring in Game Application and Technology.
...
<table width="100%">
  ...
  <tbody>
    <tr>
      <td>
        <img src="https://github.com/BSNnoob/BSNnoob/blob/main/DInQgo.png?raw=true" style="width:300px;height:200px;">
      </td>
      <td>
        <img src="https://github.com/BSNnoob/BSNnoob/blob/main/29KDy8.png?raw=true" style="width:300px;height:200px;">
      </td>
      <td>
        <img src="https://github.com/BSNnoob/BSNnoob/blob/main/https://raw.githubusercontent.com/BSNnoob/BSNnoob/main/NclO0%2B.png?raw=true" style="width:300px;height:200px;">
      </td>
    </tr>
    <tr>
      <td valign="text-top">
        ...
        <br><br>
        <b>Dice Turret</b> is a tower‑defense inspired game where dice mechanics are used to attack incoming enemies.
      </td>
      <td valign="text-top">
        <b>Roll for Treasure</b> is a board‑game inspired adventure based on Snake and Ladder mechanics, but with added treasure‑hunting twists.
      </td>
      <td valign="text-top">
